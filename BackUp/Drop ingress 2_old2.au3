...
;~ 		touch_x_y(31051, 30481) ;OPS
		...
		If StringInStr($item, "R") Then $YCord = $YCord - ($lvl * 5650)
		If StringInStr($item, "X") Then $YCord = $YCord - ($lvl * 5650 * 2 )
		If StringInStr($item, "C") Then $YCord = $YCord - ($lvl * 5650 * 4 )
		If StringInStr($item, "M") Then $YCord = $YCord - ($lvl * 5650 * 5 )
...
Func reciclar_bluestacks($veces)
	For $i = 1 To $veces
